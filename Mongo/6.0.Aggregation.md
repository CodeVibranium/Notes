...
- in aggregation pipeline, documents goes thiugh stages in **SEQUENTIAL** order
- and o/p of one will be inoput for another.
...
**ORDER SORT, SKIP and ONLY then LIMIT**
